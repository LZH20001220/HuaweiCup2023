    ...
    methods
        ...
        function PlotAllEvent(obj)
            ...
            for i = 1:length(obj.APs)
                ...
                %修改x,y轴标签
                ylabel('\fontname{宋体}\fontsize{10}传输结果');
                xlabel('\fontname{宋体}\fontsize{10}时间(us)');
        ...
        function [avg_throughput, p_c] = PlotThroughput(obj, gap)
            ...
            cc= {'#FA4224', '#048243','#DBB40C'};
            line = {'AP1吞吐量','AP2吞吐量','系统总吞吐量'};
            ...
            plot(x,throughput_all,'Color',cc{3});
            hold off;
            legend(line);
            ax = gca;
